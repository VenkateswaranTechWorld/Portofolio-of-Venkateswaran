  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Hi, I’m <strong>VENKATESWARAN A</strong> — an aspiring{" "}
          <strong>Software Engineer</strong> and{" "}
          <strong>Coding Developer</strong> who loves turning ideas
        ...
        <p>
            3rd-year B.E Computer Science Engineering student with hands-on experience in Frontend & AI Projects. Proficient in Python, Fullstack,Frontend & Backend,JavaScript,C & C++ and data preprocessing. Seeking internship opportunities to apply skills and contribute to
            impactful solutions.
        </p>
          ...
          >
            ...
            >
              ...
              <div>
                ...
                >
                  <strong>A.U (Anna University)</strong> — Guindy,
                  Chennai
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>
                  3rd Year (Pursuing) | GPA: 8.47
                </p>
            ...
            >
              ...
              <div>
                ...
                >
                  <strong>ST.MARY'S Higher Secondary School</strong> — East
                  Veli Street, Madurai
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>
                  State Board Of Tamilnadu
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>Completed in 2022-2023</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                ...
                <p style={{ color: "rgba(255,255,255,0.7)" }}>Completed in 2020-2021</p>
              </div>
            </motion.div>
          </div>
        </motion.div>
